...
function OpenCloakroomMenu()
	...
	if Config.EnableNonFreemodePeds then
		table.insert(elements, {label = 'Politie OVD', value = 'freemode_ped', maleModel = 's_m_m_ciasec_01', femaleModel = 'ig_michelle'})
		table.insert(elements, {label = 'Politie Uniform', value = 'freemode_ped', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'})
		table.insert(elements, {label = 'Handhaving', value = 'freemode_ped', maleModel = 's_m_y_uscg_01', femaleModel = 's_f_y_cop_01'})
		table.insert(elements, {label = 'ME', value = 'freemode_ped', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_uscg_01'})
                table.insert(elements, {label = 'KMAR', value = 'freemode_ped', maleModel = 's_m_y_sheriff_01', femaleModel = 's_f_y_sheriff_01'})
                table.insert(elements, {label = 'Motor Eenheid', value = 'freemode_ped', maleModel = 's_m_y_hwaycop_01', femaleModel = 's_m_y_hwaycop_01'})
	end
